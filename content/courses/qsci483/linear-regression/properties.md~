...
In this document I will outline the math used to analyze our previous results for linear regression analysis. Make sure to check out my previous posts on [notation](/courses/qsci483/math/notation) and [simple linear regression](/courses/qsci483/math/linear-regression/linear-regression) before diving in. 
